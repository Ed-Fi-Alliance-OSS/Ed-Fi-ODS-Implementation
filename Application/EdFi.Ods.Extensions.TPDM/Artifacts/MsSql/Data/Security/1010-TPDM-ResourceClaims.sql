...
BEGIN
    DECLARE 
        ...
        @msg AS nvarchar(max),
        -- Well-known values
        @createActionId AS INT = 1,
        @readActionId AS INT = 2,
        @updateActionId AS INT = 3,
        @deleteActionId AS INT = 4
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/tpdm/staffTeacherPreparationProviderAssociation'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
            VALUES ('staffTeacherPreparationProviderAssociation', 'staffTeacherPreparationProviderAssociation', 'http://ed-fi.org/ods/identity/claims/tpdm/staffTeacherPreparationProviderAssociation', @parentResourceClaimId, @applicationId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/tpdm/teacherCandidateTeacherPreparationProviderAssociation'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
            VALUES ('teacherCandidateTeacherPreparationProviderAssociation', 'teacherCandidateTeacherPreparationProviderAssociation', 'http://ed-fi.org/ods/identity/claims/tpdm/teacherCandidateTeacherPreparationProviderAssociation', @parentResourceClaimId, @applicationId)
    ...
    -- Processing claim sets for http://ed-fi.org/ods/identity/claims/domains/tpdm/descriptors
    ----------------------------------------------------------------------------------------------------------------------------
    -- Claim set: 'Ed-Fi Sandbox'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimSetName = 'Ed-Fi Sandbox'
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/tpdm/schoolStatusDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
            VALUES ('schoolStatusDescriptor', 'schoolStatusDescriptor', 'http://ed-fi.org/ods/identity/claims/tpdm/schoolStatusDescriptor', @parentResourceClaimId, @applicationId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/tpdm/teacherPreparationProvider'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
            VALUES ('teacherPreparationProvider', 'teacherPreparationProvider', 'http://ed-fi.org/ods/identity/claims/tpdm/teacherPreparationProvider', @parentResourceClaimId, @applicationId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/tpdm/university'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
            VALUES ('university', 'university', 'http://ed-fi.org/ods/identity/claims/tpdm/university', @parentResourceClaimId, @applicationId)
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
            VALUES ('graduationPlan', 'graduationPlan', 'http://ed-fi.org/ods/identity/claims/graduationPlan', @parentResourceClaimId, @applicationId)
    ...
    -- Processing claim sets for http://ed-fi.org/ods/identity/claims/graduationPlan
    ----------------------------------------------------------------------------------------------------------------------------
    -- Claim set: 'Ed-Fi Sandbox'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimSetName = 'Ed-Fi Sandbox'
