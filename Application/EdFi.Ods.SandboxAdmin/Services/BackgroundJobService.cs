        ...
        public void Configure()
        {
            ...
            foreach (var user in _users)
            {
                ...
                if (user.Value.Sandboxes.Any(s => s.Value.Refresh))
                {
                    ...
                    //Updated following the recommendation of the update of the Hangfire 1.8
                    RecurringJob.AddOrUpdate("RebuildSandboxes", () => _engine.RebuildSandboxes(), Cron.Daily(), new RecurringJobOptions 
                    { 
