...
BEGIN
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_set_name := 'Ownership Based Test';
    claim_set_id := NULL;
    ...
    RAISE NOTICE USING MESSAGE = 'Creating authorization strategy override entry of ''OwnershipBased''' || '(authorizationStrategyId = ' || authorization_strategy_id || ' for ''Create'' action for claim set ''' || claim_set_name || ''' (claimSetId=' || claim_set_id || ', actionId = ' || Create_action_id || ').';
    ...
    RAISE NOTICE USING MESSAGE = 'Creating authorization strategy override entry of ''OwnershipBased''' || '(authorizationStrategyId = ' || authorization_strategy_id || ' for ''ReadChanges'' action for claim set ''' || claim_set_name || ''' (claimSetId=' || claim_set_id || ', actionId = ' || ReadChanges_action_id || ').';
