...
insert into dbo.ApiClients (Key, Secret, Name, IsApproved, UseSandbox, SandboxType, SecretIsHashed, Application_ApplicationId) select 'minimalKey', 'minimalSecret', 'testing', true, true, 0, false, ApplicationId from dbo.Applications;
insert into dbo.ApiClients (Key, Secret, Name, IsApproved, UseSandbox, SandboxType, SecretIsHashed, Application_ApplicationId) select 'populatedKey', 'populatedSecret', 'testing', true, true, 1, false, ApplicationId from dbo.Applications;
