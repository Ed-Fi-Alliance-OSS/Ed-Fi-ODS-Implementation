    ...
    return  @{
        SQLServer  = @{
            ConnectionStrings = @{
                ...
                ((Get-ConnectionStringKeyByDatabaseTypes)[(Get-DatabaseTypes).Security]) = "Server=(local); Trusted_Connection=True; Database=EdFi_Security;TrustServerCertificate = True; Persist Security Info=True;"
