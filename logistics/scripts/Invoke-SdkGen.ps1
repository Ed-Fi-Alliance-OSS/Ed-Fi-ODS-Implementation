...
function Invoke-SdkGen {
    ...
    $elapsed = Use-StopWatch {
        ...
        if($generateTestSdkPackage) {
            ...
            (Get-Content -path $nuspecFile -Raw) | ForEach-Object {
                $_.replace("<id>EdFi.OdsApi.Sdk</id>","<id>EdFi$suffix.OdsApi.TestSdk.$standardVersion</id>").replace("<title>EdFi.OdsApi.Sdk</title>","<title>EdFi$suffix.OdsApi.TestSdk.$standardVersion</title>").replace("<id>EdFi$suffix.OdsApi.Sdk</id>","<id>EdFi$suffix.OdsApi.TestSdk.$standardVersion</id>").replace("<title>EdFi$suffix.OdsApi.Sdk</title>","<title>EdFi$suffix.OdsApi.TestSdk.$standardVersion</title>")
            } | Set-Content -Path $nuspecFile
